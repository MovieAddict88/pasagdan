...
$total_connected_stmt = $pdo->query('SELECT COUNT(*) FROM vpn_sessions JOIN users ON vpn_sessions.user_id = users.id WHERE vpn_sessions.end_time IS NULL AND users.role = \'user\' AND users.banned = 0');
