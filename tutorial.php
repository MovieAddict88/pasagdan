...
<div class="container tutorial-page">
    ...
    <div id="troubleshooting" class="card">
        ...
        <div class="card-body">
            ...
            <div class="config-container">
            <pre><code id="ts-diag"># 1. Check basic internet connectivity
ping 8.8.8.8
...
telnet am1.vpnjantit.com 1194
                ...
                <button class="copy-btn" data-clipboard-target="#ts-diag">
                    <span class="material-icons">content_copy</span>
                    <span class="copy-text">Copy</span>
                </button>
            </div>
            ...
            <div class="config-container">
            <pre><code id="ts-reconnect"># Stability settings
keepalive 10 60
ping-timer-rem
persist-tun
persist-key
...
connect-retry-max 999
                ...
                <button class="copy-btn" data-clipboard-target="#ts-reconnect">
                    <span class="material-icons">content_copy</span>
                    <span class="copy-text">Copy</span>
                </button>
            </div>
            ...
            <div class="config-container">
            <pre><code id="ts-speed"># Speed optimization
tun-mtu 1500
mssfix 1450
sndbuf 393216
rcvbuf 393216
...
fast-io
                ...
                <button class="copy-btn" data-clipboard-target="#ts-speed">
                    <span class="material-icons">content_copy</span>
                    <span class="copy-text">Copy</span>
                </button>
            </div>
            ...
            <div class="config-container">
            <pre><code id="ts-globe">APN: http.globe.com.ph
...
Special: Use vip.facebook.com for better stability
                ...
                <button class="copy-btn" data-clipboard-target="#ts-globe">
                    <span class="material-icons">content_copy</span>
                    <span class="copy-text">Copy</span>
                </button>
            </div>
...
Special: 5G proxies work better
            ...
            <h5>GLOBE PROXIES:</h5>
            <div class="config-container">
            <pre><code id="ts-globe-proxies"># Main Proxies:
...
110.78.141.147 8888
                ...
                <button class="copy-btn" data-clipboard-target="#ts-globe-proxies">
                    <span class="material-icons">content_copy</span>
                    <span class="copy-text">Copy</span>
                </button>
            </div>
            ...
            <div class="config-container">
            <pre><code id="ts-smart-proxies"># Internal Proxies (10.x.x.x):
...
10.102.95.1 8080      # Facebook
                ...
                <button class="copy-btn" data-clipboard-target="#ts-smart-proxies">
                    <span class="material-icons">content_copy</span>
                    <span class="copy-text">Copy</span>
                </button>
            </div>
            ...
            <h5>DITO PROXIES:</h5>
            <div class="config-container">
            <pre><code id="ts-dito-proxies"># Primary Proxies:
...
122.55.1.3 3128
                ...
                <button class="copy-btn" data-clipboard-target="#ts-dito-proxies">
                    <span class="material-icons">content_copy</span>
                    <span class="copy-text">Copy</span>
                </button>
            </div>
            ...
            <p>Option 1 (Basic):</p>
            <div class="config-container">
            <pre><code id="ts-header-basic">http-proxy-option AGENT "Mozilla/5.0 (Linux; Android 13)"
...
http-proxy-option CUSTOM-HEADER "Connection: Keep-Alive"
                ...
                <button class="copy-btn" data-clipboard-target="#ts-header-basic">
                    <span class="material-icons">content_copy</span>
                    <span class="copy-text">Copy</span>
                </button>
            </div>
            ...
            <div class="config-container">
            <pre><code id="ts-header-advanced">http-proxy-option AGENT "Dalvik/2.1.0 (Linux; U; Android 11)"
http-proxy-option VERSION 1.1
...
http-proxy-option CUSTOM-HEADER "Proxy-Connection: keep-alive"
                ...
                <button class="copy-btn" data-clipboard-target="#ts-header-advanced">
                    <span class="material-icons">content_copy</span>
                    <span class="copy-text">Copy</span>
                </button>
            </div>
            ...
            <p>Globe Promos:</p>
            <div class="config-container">
            <pre><code id="ts-globe-headers"># Go+99:
...
X-Online-Host: instagram.com
                ...
                <button class="copy-btn" data-clipboard-target="#ts-globe-headers">
                    <span class="material-icons">content_copy</span>
                    <span class="copy-text">Copy</span>
                </button>
            </div>
            ...
            <div class="config-container">
            <pre><code id="ts-smart-headers"># POWER ALL:
...
X-Online-Host: tt.smart.com.ph
                ...
                <button class="copy-btn" data-clipboard-target="#ts-smart-headers">
                    <span class="material-icons">content_copy</span>
                    <span class="copy-text">Copy</span>
                </button>
            </div>
            ...
            <p>DITO Promos:</p>
            <div class="config-container">
            <pre><code id="ts-dito-headers"># Level-Up:
...
X-Online-Host: gaming.dito.ph
                ...
                <button class="copy-btn" data-clipboard-target="#ts-dito-headers">
                    <span class="material-icons">content_copy</span>
                    <span class="copy-text">Copy</span>
                </button>
            </div>
            ...
            <div class="config-container">
            <pre><code id="ts-termux">#!/bin/bash
...
echo "Working proxies saved to working_proxies.txt"
                ...
                <button class="copy-btn" data-clipboard-target="#ts-termux">
                    <span class="material-icons">content_copy</span>
                    <span class="copy-text">Copy</span>
                </button>
            </div>
            ...
            <div class="config-container">
            <pre><code id="ts-tls"># Solution:
cipher AES-128-CBC
auth SHA1
remote-cert-tls server
</code></pre>
                <button class="copy-btn" data-clipboard-target="#ts-tls">
                    <span class="material-icons">content_copy</span>
                    <span class="copy-text">Copy</span>
                </button>
            </div>
            ...
            <p>SOCKET ERROR</p>
            <div class="config-container">
            <pre><code id="ts-socket"># Add to config:
proto tcp
tun-mtu 1500
mssfix 1450
</code></pre>
                <button class="copy-btn" data-clipboard-target="#ts-socket">
                    <span class="material-icons">content_copy</span>
                    <span class="copy-text">Copy</span>
                </button>
            </div>
            ...
            <div class="config-container">
            <pre><code id="ts-dns"># Add to config:
dhcp-option DNS 8.8.8.8
dhcp-option DNS 8.8.4.4
dhcp-option DNS 1.1.1.1
</code></pre>
                <button class="copy-btn" data-clipboard-target="#ts-dns">
                    <span class="material-icons">content_copy</span>
                    <span class="copy-text">Copy</span>
                </button>
            </div>
            ...
            <p>Globe:</p>
            <div class="config-container">
            <pre><code id="ts-globe-status">*143# → Check balance
Text BAL to 8080
Text GOSURF STATUS to 8080
</code></pre>
                <button class="copy-btn" data-clipboard-target="#ts-globe-status">
                    <span class="material-icons">content_copy</span>
                    <span class="copy-text">Copy</span>
                </button>
            </div>
            <p>Smart/TNT:</p>
            <div class="config-container">
            <pre><code id="ts-smart-status">*123# → Check promo
Text BAL to 9999 (Smart) / 4545 (TNT)
Text INFO to respective number
</code></pre>
                <button class="copy-btn" data-clipboard-target="#ts-smart-status">
                    <span class="material-icons">content_copy</span>
                    <span class="copy-text">Copy</span>
                </button>
            </div>
            <p>DITO:</p>
            <div class="config-container">
            <pre><code id="ts-dito-status">*185# → Check balance
Text BAL to 185
Text STATUS to 185
</code></pre>
                <button class="copy-btn" data-clipboard-target="#ts-dito-status">
                    <span class="material-icons">content_copy</span>
                    <span class="copy-text">Copy</span>
                </button>
            </div>
            ...
            <p>Android:</p>
            <div class="config-container">
            <pre><code id="ts-android"># Developer Options:
1. Enable "Stay awake"
...
- Disable adaptive battery for VPN
                ...
                <button class="copy-btn" data-clipboard-target="#ts-android">
                    <span class="material-icons">content_copy</span>
                    <span class="copy-text">Copy</span>
                </button>
            </div>
            <p>iOS:</p>
            <div class="config-container">
            <pre><code id="ts-ios"># VPN Settings:
1. Enable "Connect on Demand"
2. Disable "IPV6"
3. Use IKEv2 if OpenVPN fails
</code></pre>
                <button class="copy-btn" data-clipboard-target="#ts-ios">
                    <span class="material-icons">content_copy</span>
                    <span class="copy-text">Copy</span>
                </button>
            </div>
            <p>Windows:</p>
            <div class="config-container">
            <pre><code id="ts-windows"># Network Settings:
1. Disable IPV6
2. Set DNS to 8.8.8.8
3. Disable proxy auto-detection
</code></pre>
                <button class="copy-btn" data-clipboard-target="#ts-windows">
                    <span class="material-icons">content_copy</span>
                    <span class="copy-text">Copy</span>
                </button>
            </div>
            ...
            <div class="config-container">
            <pre><code id="ts-flowchart">Start → No Internet
       ↓
1. Test without VPN
       ↓
...
End → Working/Not Working
                ...
                <button class="copy-btn" data-clipboard-target="#ts-flowchart">
                    <span class="material-icons">content_copy</span>
                    <span class="copy-text">Copy</span>
                </button>
            </div>
...
&lt;/ca&gt;
                ...
                <button class="copy-btn" data-clipboard-target="#ts-backup">
                    <span class="material-icons">content_copy</span>
                    <span class="copy-text">Copy</span>
                </button>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    clipboard.on('success', function(e) {
        ...
        e.trigger.innerHTML = '<span class="material-icons">check</span> Copied!';
        setTimeout(function() {
